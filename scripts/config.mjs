...
export const RSS_SOURCES = [
  ...
  },
  {
    id: 'xai-github',
    name: 'xAI GitHub',
    url: 'https://github.com/xai-org.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  ...
  },
  {
    id: 'nvidia-github',
    name: 'NVIDIA GitHub',
    url: 'https://github.com/NVIDIA.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'thudm-github',
    name: 'THUDM (智谱) GitHub',
    url: 'https://github.com/THUDM.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'bytedance-seed-github',
    name: 'ByteDance Seed GitHub',
    url: 'https://github.com/ByteDance-Seed.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'tencent-hunyuan-github',
  ...
  // --- 中国厂商 GitHub ---
  {
    id: 'paddlepaddle-github',
    name: 'PaddlePaddle (飞桨) GitHub',
    url: 'https://github.com/PaddlePaddle.atom',
    tier: 2,
    language: 'zh',
    category: 'ecosystem',
  },
  {
    id: 'tencent-github',
    name: 'Tencent GitHub',
    url: 'https://github.com/Tencent.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'tencent-ailab-github',
    name: 'Tencent AI Lab GitHub',
    url: 'https://github.com/Tencent-AILab.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'huawei-github',
    name: 'Huawei GitHub',
    url: 'https://github.com/huawei.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'huawei-noah-github',
    name: 'Huawei Noah GitHub',
    url: 'https://github.com/Huawei-noah.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'zhipuai-github',
    name: 'Zhipu AI GitHub',
    url: 'https://github.com/zhipuai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'baichuan-github',
    name: 'Baichuan GitHub',
    url: 'https://github.com/baichuan-inc.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    ...
    url: 'https://github.com/MoonshotAI.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'minimax-github',
    name: 'MiniMax GitHub',
    url: 'https://github.com/MiniMax-AI.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: '01ai-github',
    name: '01.AI GitHub',
    url: 'https://github.com/01-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'sensetime-github',
    name: 'SenseTime GitHub',
    url: 'https://github.com/SenseTime.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  // --- 美国/国际厂商 GitHub ---
  {
    id: 'characterai-github',
    name: 'Character.AI GitHub',
    url: 'https://github.com/character-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'ai21-github',
    name: 'AI21 Labs GitHub',
    url: 'https://github.com/ai21labs.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'cohere-github',
    name: 'Cohere GitHub',
    url: 'https://github.com/cohere-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'together-github',
    name: 'Together AI GitHub',
    url: 'https://github.com/together-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'perplexity-github',
    name: 'Perplexity GitHub',
    url: 'https://github.com/perplexity-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'wandb-github',
    name: 'Weights & Biases GitHub',
    url: 'https://github.com/wandb.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'ibm-research-github',
    name: 'IBM Research GitHub',
    url: 'https://github.com/ibm-research.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'stability-github',
    name: 'Stability AI GitHub',
    url: 'https://github.com/Stability-AI.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'scale-github',
    name: 'Scale AI GitHub',
    url: 'https://github.com/scaleapi.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    ...
    url: 'https://github.com/replicate.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'ollama-github',
    name: 'Ollama GitHub',
    url: 'https://github.com/ollama.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  // --- 应用/基础设施 GitHub ---
  {
    id: 'runway-github',
    name: 'Runway GitHub',
    url: 'https://github.com/runwayml.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'elevenlabs-github',
    name: 'ElevenLabs GitHub',
    url: 'https://github.com/elevenlabs.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'notion-github',
    name: 'Notion GitHub',
    url: 'https://github.com/makenotion.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'figma-github',
    name: 'Figma GitHub',
    url: 'https://github.com/figma.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'canva-github',
    name: 'Canva GitHub',
    url: 'https://github.com/canva.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'adobe-github',
    name: 'Adobe GitHub',
    url: 'https://github.com/adobe.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  // --- 欧洲/亚洲 GitHub ---
  {
    id: 'alephalpha-github',
    name: 'Aleph Alpha GitHub',
    url: 'https://github.com/Aleph-Alpha.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'graphcore-github',
    name: 'Graphcore GitHub',
    url: 'https://github.com/graphcore.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'helsing-github',
    name: 'Helsing GitHub',
    url: 'https://github.com/helsing-ai.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'pfnet-github',
    name: 'Preferred Networks GitHub',
    url: 'https://github.com/pfnet.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'naver-github',
    name: 'Naver GitHub',
    url: 'https://github.com/naver.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'samsung-github',
    name: 'Samsung GitHub',
    url: 'https://github.com/Samsung.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  {
    id: 'kaist-github',
    name: 'KAIST AI Lab GitHub',
    url: 'https://github.com/KAIST-AILab.atom',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
  },
  ...
  },
  {
    ...
    url: 'https://www.databricks.com/blog/feed.xml',
    tier: 2,
    language: 'en',
    category: 'ecosystem',
    proxy: true,
  ...
  },
  {
    id: 'adobe-blog',
    name: 'Adobe Blog',
    url: 'https://blog.adobe.com/en/publish/feed',
    tier: 2,
    language: 'en',
    category: 'media',
    requireKeywordFilter: true,
